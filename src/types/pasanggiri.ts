export type UserRole = 'SUPER_ADMIN' | 'ADMIN' | 'KOORDINATOR_PUTRA' | 'KOORDINATOR_PUTRI' | 'SIRKULATOR_PUTRA' | 'SIRKULATOR_PUTRI' | 'JURI_PUTRA' | 'JURI_PUTRI' | 'VIEWER';
...
export interface PasanggiriDesa {
  id: number;
  nama_desa: string;
  created_at: string;
}
